...
const path = require('path'); // Needed to serve the frontend file
...
// It tells Express to serve any files it finds in the 'public' folder.
...
app.get('/api/audit', async (req, res) => {
    ...
    try {
        ...
        const auditResults = allProperties.map(prop => {
            ...
            return { label: prop.label, internalName: prop.name, type: prop.type, fillRate, fillCount: estimatedTotalFillCount };
        });
